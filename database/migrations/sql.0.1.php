...
$sql[] = "CREATE TABLE `{prefix}staff_service_group` ( 
	`id` BIGINT NOT NULL AUTO_INCREMENT , 
	`staff_service_id` BIGINT DEFAULT NULL , 
	`capacity_min` INT DEFAULT NULL , 
	`capacity_max` INT DEFAULT NULL , 
	PRIMARY KEY (`id`)
){charset_collate};";
...
$sql[] = "ALTER TABLE `{prefix}staff_service_group` ADD  CONSTRAINT `staff_service_group_staff_service_id_fk` FOREIGN KEY (`staff_service_id`) REFERENCES `{prefix}staff_service`(`id`) ON DELETE CASCADE ON UPDATE RESTRICT;";
