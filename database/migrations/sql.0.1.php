...
$sql[] = "ALTER TABLE `{prefix}service_group` ADD UNIQUE KEY unique_service (service_id);";
...
$sql[] = "ALTER TABLE `{prefix}appointment_group` ADD UNIQUE KEY unique_appointment (appointment_id);";
